...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    const obstacles = [
      ...
      // PHASE 5 — INTEGRATION BOSS HURDLE
      {
        id: 'g-5.1',
        track: 'genetics',
        phase: 5,
        phaseLabel: 'Phase 5 — Integration Boss Hurdle',
        order: 13,
        name: 'Global Megabase Chromosomal Integration',
        shortName: 'Boss Hurdle: Chromosomal Integration',
        isBoss: true,
        theoreticalTarget:
          'Safely integrate a synthetic genetic array of ≥5 megabases (encoding telomere maintenance, senolytic triggers, identity verification circuits, and P2P re-flash receivers) across multiple chromosomal safe-harbour loci in ≥95% of cells in a living subject — with confirmed ADAMA (Anti-Deletional, Anti-Mutagenic Assurance) safeguards preventing oncogenic insertion, exon disruption, or chromosomal rearrangement.',
        milestones: [
          {
            id: 'g-5.1.1',
            name: 'Safe harbour locus map expanded to ≥10 validated human chromosomal sites capable of accommodating >500 kb inserts without disrupting endogenous gene function — AAVS1, ROSA26 equivalents confirmed',
            completed: false,
            evidence: ''
          },
          {
            id: 'g-5.1.2',
            name: 'Megabase-scale synthetic array delivery vehicle (engineered Human Artificial Chromosome or fragmented episomal array) demonstrates stable replication through ≥100 cell divisions without integration-site silencing',
            completed: false,
            evidence: ''
          },
          {
            id: 'g-5.1.3',
            name: 'Multiplexed safe-harbour integration of full synthetic array validated in iPSC-derived cells representing all three germ layers — expression fidelity >90% of design specification confirmed',
            completed: false,
            evidence: ''
          },
          {
            id: 'g-5.1.4',
            name: 'In vivo integration in porcine model demonstrates <1 oncogenic insertion event per 10⁸ cells at 24-month follow-up — whole-genome sequencing of 500+ cells confirms chromosomal stability',
            completed: false,
            evidence: ''
          }
        ],
        anchors: [
          ...
          'Human Artificial Chromosome (HAC) technology — Kazuki/Oshimura Lab Tottori University',
          'Tessera Therapeutics — gene writing (retrotransposon-based large insert)',
          'Tome Biosciences — programmable genomic integration platform',
          'Recombineering — λ Red recombinase-based large-scale editing',
          'EvoBiologics — genomic safe harbour computational mapping'
        ],
        status: 'active',
        papers: [],
        lastUpdated: now
      ...
      // PHASE 4 — INTEGRATION BOSS HURDLE
      {
        id: 'n-4.1',
        track: 'nanotech',
        phase: 4,
        phaseLabel: 'Phase 4 — Integration Boss Hurdle',
        order: 10,
        name: 'Mass Swarm Cohesion Integration',
        shortName: 'Boss Hurdle: Swarm Integration',
        isBoss: true,
        theoreticalTarget:
