  ...
  try {
    ...
    const obstacles = [
      ...
      },
      {
        ...
        isBoss: true,
        theoreticalTarget:
          'Demonstrate simultaneous, coordinated operation of all Track 01 subsystems within a single mammalian organism, with confirmed systemic somatic identity integrity across ≥10^12 cells.',
        milestones: [
          {
            id: 'g-5.2.1',
